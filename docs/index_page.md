...
- 初めて C# を触る: [00_環境構築](00_環境構築/README.md) → [01_基礎文法](01_基礎文法/README.md) → [コンソール電卓](12_実践プロジェクト/01_console-calculator.md)
- コンソールアプリを作る: [01_基礎文法](01_基礎文法/README.md) → [03_コレクションとLINQ](03_コレクションとLINQ/README.md) → [TODO CLI](12_実践プロジェクト/02_todo-cli.md)
- Web API を作る: [ASP.NET Core の構造](10_WebとAPI/01_ASPNETCoreの構造.md) → [Minimal API](10_WebとAPI/02_MinimalAPI.md) → [TODO Web API](12_実践プロジェクト/05_todo-web-api.md)
- DB 付き API を作る: [EF Core の基本](09_データアクセス/03_EFCoreの基本.md) → [Migration](09_データアクセス/05_Migration.md) → [DB 付き CRUD アプリ](12_実践プロジェクト/06_db付きcrudアプリ.md)
- チーム開発に備える: [08_テストと品質](08_テストと品質/README.md) → [GitHub Actions](11_ツールと運用/05_GitHubActions.md) → [PR 提出チェックリスト](12_実践プロジェクト/09_PR提出チェックリスト.md)

## 症状から探す

- `dotnet` や restore で詰まる: [`dotnet` が見つからない](90_逆引き/01_dotnetが見つからない.md), [NuGet 復元エラー](90_逆引き/04_NuGet復元エラー.md)
- build / test が失敗する: [ビルドエラーの読み方](90_逆引き/02_ビルドエラーの読み方.md), [CI で dotnet test 失敗](90_逆引き/11_CIでdotnet-test失敗.md)
- null / nullable warning を直したい: [null 関連エラー](90_逆引き/03_null関連エラー.md), [nullable reference types](06_型システムと言語機能/01_nullable-reference-types.md)
- 非同期処理が止まる、例外が追えない: [async / await 誤用](90_逆引き/12_async-await誤用.md), [非同期デッドロック](90_逆引き/13_非同期デッドロック.md)
- EF Core が遅い、SQL が多い: [EF Core N+1 問題](90_逆引き/14_EFCoreN+1問題.md), [EF Core 診断](09_データアクセス/13_EFCore診断.md)
- browser から API を呼べない: [CORS エラー](90_逆引き/15_CORSエラー.md), [CORS](10_WebとAPI/13_CORS.md)
- 429 や API 制限を調べたい: [Rate limit と 429](90_逆引き/16_RateLimitと429.md), [Rate Limiting と Caching](10_WebとAPI/14_RateLimitingとCaching.md)
...
- [インストール手順チェックリスト](00_環境構築/06_インストール手順チェックリスト.md)
...
- [TimeProvider](04_標準ライブラリ/08_TimeProvider.md)
- [HttpClientFactory](04_標準ライブラリ/09_HttpClientFactory.md)
- [JSON 互換性と命名規則](04_標準ライブラリ/10_JSON互換性と命名規則.md)
...
- [Task の基本](05_非同期と並行処理/01_Taskの基本.md)
- [async / await](05_非同期と並行処理/02_async-await.md)
- [CancellationToken](05_非同期と並行処理/03_CancellationToken.md)
- [Task.WhenAll](05_非同期と並行処理/04_TaskWhenAll.md)
- [Parallel 処理](05_非同期と並行処理/05_Parallel処理.md)
- [Channel の入口](05_非同期と並行処理/06_Channelの入口.md)
- [非同期処理のよくある落とし穴](05_非同期と並行処理/07_非同期処理のよくある落とし穴.md)
- [非同期ストリーム](05_非同期と並行処理/08_非同期ストリーム.md)
- [タイムアウトとリトライ](05_非同期と並行処理/09_タイムアウトとリトライ.md)
- [スレッド安全性](05_非同期と並行処理/10_スレッド安全性.md)
...
- [generics](06_型システムと言語機能/02_generics.md)
- [pattern matching](06_型システムと言語機能/03_pattern-matching.md)
- [extension methods](06_型システムと言語機能/04_extension-methods.md)
- [attributes](06_型システムと言語機能/05_attributes.md)
- [reflection](06_型システムと言語機能/06_reflection.md)
- [using と namespace](06_型システムと言語機能/07_usingとnamespace.md)
- [required と init](06_型システムと言語機能/08_requiredとinit.md)
- [record と値の等価性](06_型システムと言語機能/09_recordと値の等価性.md)
- [primary constructor](06_型システムと言語機能/10_primary-constructor.md)
...
- [DI の考え方](07_設計と実務パターン/02_DIの考え方.md)
- [例外設計](07_設計と実務パターン/03_例外設計.md)
- [ログ設計](07_設計と実務パターン/04_ログ設計.md)
...
- [xUnit の基本](08_テストと品質/01_xUnitの基本.md)
- [Arrange / Act / Assert](08_テストと品質/02_ArrangeActAssert.md)
- [モックとスタブ](08_テストと品質/03_モックとスタブ.md)
- [テストしやすい設計](08_テストと品質/04_テストしやすい設計.md)
- [dotnet format](08_テストと品質/05_dotnet-format.md)
...
- [SQL の基礎](09_データアクセス/01_SQLの基礎.md)
- [ADO.NET の入口](09_データアクセス/02_ADONETの入口.md)
- [EF Core の基本](09_データアクセス/03_EFCoreの基本.md)
- [DbContext と Entity](09_データアクセス/04_DbContextとEntity.md)
...
- [楽観的同時実行制御](09_データアクセス/09_楽観的同時実行制御.md)
- [接続文字列と Secret](09_データアクセス/10_接続文字列とSecret.md)
- [Repository パターンの判断](09_データアクセス/11_Repositoryパターンの判断.md)
...
- [ASP.NET Core の構造](10_WebとAPI/01_ASPNETCoreの構造.md)
- [Minimal API](10_WebとAPI/02_MinimalAPI.md)
- [Controller / MVC](10_WebとAPI/03_ControllerMVC.md)
- [Routing](10_WebとAPI/04_Routing.md)
- [Request / Response](10_WebとAPI/05_RequestResponse.md)
- [Validation](10_WebとAPI/06_Validation.md)
...
- [Endpoint Filters](10_WebとAPI/10_EndpointFilters.md)
- [API バージョニング](10_WebとAPI/11_APIバージョニング.md)
...
- [solution と project](11_ツールと運用/03_solutionとproject.md)
...
- [デプロイ前チェックリスト](11_ツールと運用/11_デプロイ前チェックリスト.md)
...
- [ビルドエラーの読み方](90_逆引き/02_ビルドエラーの読み方.md)
- [null 関連エラー](90_逆引き/03_null関連エラー.md)
- [NuGet 復元エラー](90_逆引き/04_NuGet復元エラー.md)
- [よく使う dotnet コマンド](90_逆引き/05_よく使うdotnetコマンド.md)
- [VS Code で補完が効かない](90_逆引き/06_VSCodeで補完が効かない.md)
- [DI 登録漏れ](90_逆引き/07_DI登録漏れ.md)
- [Options 検証エラー](90_逆引き/08_Options検証エラー.md)
- [EF Core Migration 失敗](90_逆引き/09_EFCoreMigration失敗.md)
- [HttpClient タイムアウト](90_逆引き/10_HttpClientタイムアウト.md)
- [CI で dotnet test 失敗](90_逆引き/11_CIでdotnet-test失敗.md)
- [async / await 誤用](90_逆引き/12_async-await誤用.md)
- [非同期デッドロック](90_逆引き/13_非同期デッドロック.md)
- [EF Core N+1 問題](90_逆引き/14_EFCoreN+1問題.md)
- [CORS エラー](90_逆引き/15_CORSエラー.md)
- [Rate limit と 429](90_逆引き/16_RateLimitと429.md)
- [SQL Injection 対策](90_逆引き/17_SQLInjection対策.md)
- [デプロイ失敗](90_逆引き/18_デプロイ失敗.md)
- [Container 起動失敗](90_逆引き/19_Container起動失敗.md)
- [EF Core 性能問題](90_逆引き/20_EFCore性能問題.md)
- [Microsoft Learn 学習ルート](99_参考資料/01_MicrosoftLearn学習ルート.md)
- [C# バージョン差分](99_参考資料/02_CSharpバージョン差分.md)
- [.NET 8 / .NET 10 差分](99_参考資料/03_dotnet8-dotnet10差分.md)
- [推奨書籍](99_参考資料/04_推奨書籍.md)
- [用語と一次情報リンク集](99_参考資料/05_用語と一次情報リンク集.md)
- [公式ドキュメントの読み方](99_参考資料/06_公式ドキュメントの読み方.md)
- [バージョン追跡とアップグレード方針](99_参考資料/07_バージョン追跡とアップグレード方針.md)
...
- 18章構成との対応を確認したい: [18章アウトライン対応表](99_参考資料/08_18章アウトライン対応表.md)
- CLR、GC、Span、assembly を学びたい: [13_ランタイムと高度なCSharp](13_ランタイムと高度なCSharp/README.md)

## 共通資料

- [ROADMAP](roadmap.md)
- [演習問題](80_演習問題/README.md)
- [GLOSSARY](glossary.md)
- [CHANGELOG](changelog.md)
- [記事テンプレート](_templates/article.md)
- [実習テンプレート](_templates/practice.md)
