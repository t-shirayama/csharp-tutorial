...
配列、List、Dictionary、IEnumerable、LINQ を扱うカテゴリです。
...
- コレクションを目的に応じて選べる。
- LINQ で読みやすい変換、抽出、集計を書ける。
- 遅延評価による挙動の違いを説明できる。
- 複数コレクションの結合、materialize、読みやすさの判断ができる。
- 集合、キュー、スタック、不変コレクション、Index / Range を目的に応じて選べる。
- ソート、ページング、取得系 LINQ、collection の公開方法を実務の判断基準で選べる。

## 次に進むカテゴリ

- [04_標準ライブラリ](../04_標準ライブラリ/README.md)
