...
- [DI コンテナの実装](../07_設計と実務パターン/09_DIコンテナの実装.md) を参考に、TODO service を Scoped で登録する。
- [IOptions と Configuration](../07_設計と実務パターン/10_IOptionsとConfiguration.md) を参考に、ページサイズなどの設定を Options として扱う。
- [ILogger と構造化ログ](../07_設計と実務パターン/11_ILoggerと構造化ログ.md) を参考に、`TodoId` などの業務 ID をログに含める。
- [グローバルエラーハンドリング](../07_設計と実務パターン/12_グローバルエラーハンドリング.md) を参考に、エラーレスポンスを ProblemDetails で統一する。
